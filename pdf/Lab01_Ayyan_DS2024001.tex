...
\caption{Database tree screenshot}
...
\caption{git logs and results screenshot}
\label{fig:final}
\end{figure}
...
\subsubsection{AI Tool:} Claude / Qwen
...
\vspace{0.5cm}
\noindent \textbf{GitHub Repository:} The code and resources for this lab can be found at: \url{https://github.com/Ayyankhan101/DATABASE-LAB.git}
