...
-- Query 4: Active cities (more than 2 orders)
SELECT c.city,
...
-- Query 6b: Each customer's highest-value order
...
-- Query 7: Overall revenue ranking with RANK
SELECT order_id,
       customer_id,
       total_amount,
