...
-- Query 3: Filter by status (delivered orders)
...
-- Query 7: Pattern matching on email (Gmail users)
...
-- Query 9: Computed column (20% discount)
SELECT product_name,
       category,
...
-- Query 10: Top 5 highest-value unshipped orders from 2025 with priority
-- Extended: CRITICAL (>20000), URGENT (5000-20000), NORMAL (<=5000)
SELECT order_id,
       customer_id,
       total_amount,
       order_date,
